...
if ($nowTime>= 3600) {//如果时间差值大于等于3600秒，那么就重新获取access_token
    $res = file_get_contents('https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx60cc0b8b6bb0e83b&secret=a2f09aa037f335194e2dafb5d157a55f');//测试账号的appid与secret
